...
namespace Project_ktr_msc.Data.Migrations
{
    ...
    [Migration("20200919150703_Migration3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_ktr_msc.Entities.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project_ktr_msc.Entities.Profiles.Library", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Project_ktr_msc.Entities.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Project_ktr_msc.Entities.Profiles.Library", b =>
                {
                    b.HasOne("Project_ktr_msc.Entities.Identity.ApplicationUser", "Owner")
                        .WithOne("Library")
                        .HasForeignKey("Project_ktr_msc.Entities.Profiles.Library", "OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
